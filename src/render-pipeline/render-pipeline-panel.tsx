...
import {
  ...
  type RenderPipelinePolicy,
  type RenderProgramCandidate,
  type RenderSourceRefreshTarget,
} from "./render-pipeline-policy";

export type { RenderProgramCandidate } from "./render-pipeline-policy";
...
type RenderPipelineMutationContext = Readonly<{
...
function mutationTargetIsCurrent(target: RenderMutationTarget, context: RenderPipelineMutationContext) {
...
function mutationMayBeAborted(target: RenderMutationTarget) {
  return (
