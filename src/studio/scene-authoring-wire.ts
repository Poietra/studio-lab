...
function normalizedStudioCreationOperation(
  ...
  if (operation.kind === "CreateEntity") {
    ...
    return {
      ...common,
      entity: {
        ...(type === "CubicBezier" ? { cubicBezier: operation.entity.cubicBezier ?? null } : {}),
        dataSeries: operation.entity.dataSeries ?? null,
                ...
                : entity.type === "Ellipse"
                  ...
                  : entity.type === "Triangle" || entity.type === "RegularPolygon"
                    ...
                    : entity.type === "ImageMobject"
                      ...
                      : entity.type === "MathTex"
                        ? "math-tex"
                        : entity.type === "NumberLine"
                          ? "number-line"
                          : entity.type === "NumberPlane"
                            ? "number-plane"
                            : entity.type === "Rectangle"
                              ? "rectangle"
                              : entity.type === "Sector"
