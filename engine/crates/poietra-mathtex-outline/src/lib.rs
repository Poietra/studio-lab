...
pub use text::{
    ...
    TextOutlineArtifactV1, TextOutlineBoundsV1, TextOutlineGlyphFragmentV1,
    TextOutlineGlyphSourceCorrelationV1, TextOutlineLayoutV1, TextOutlineRequestSchemaV1,
