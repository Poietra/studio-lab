...
pub use authoring::{
    ...
    StudioMathTexContent, StudioMathTexContentEntityIdentity, StudioMathTexContentOperation,
    StudioMathTexContentOutline, StudioMathTexContentProgram, StudioMathTexContentSourceBinding,
