...
pub use authoring::{
    ...
    StudioCreationSvgPathSpec, StudioCreationTextOutline, StudioCubicBezierError,
    StudioCubicBezierInspection, StudioCubicBezierStrokeCap, StudioFragmentMaterialAssignment,
    StudioMathTexContent, StudioMathTexTransformEditInput, StudioMathTexTransformEntityIdentity,
    ...
    StudioProjectionEasing, StudioPropertyEasing, StudioSvgPathAssetInspection, StudioSvgPathError,
