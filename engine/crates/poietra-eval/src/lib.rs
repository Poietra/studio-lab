...
pub use authoring::{
    ...
    ApplyStudioMotionEditError, ApplyStudioPersistentRemoveError, ApplyStudioTimelineEditCommand,
    ApplyStudioTimelineEditError, CreateSceneEntitiesError, StaticRootTransformDimensions,
    ...
    StudioCreationOperationKind, StudioCreationProgram, StudioMotionEasing,
    StudioMotionEntityIdentity, StudioMotionOperation, StudioMotionProgram,
    StudioMotionSourceBinding, StudioPersistentRemoveProjection,
