...
pub use authoring::{
    ...
    StudioBoundEntityScheduleMode, StudioCreationCubicBezierSpec, StudioCreationEditInput,
    StudioCreationEntitySpec, StudioCreationImageSpec, StudioCreationMathTexOutline,
    ...
    StudioCubicBezierError, StudioCubicBezierInspection, StudioCubicBezierStrokeCap,
    StudioFragmentMaterialAssignment, StudioMathTexContent, StudioMathTexTransformEditInput,
    ...
    StudioMathTexTransformProjection, StudioMathTexTransformProjectionEntityIdentity,
    StudioMathTexTransformSourceBinding, StudioMathTexTransformStrategy, StudioMotionEasing,
    StudioMotionEditInput, StudioMotionEntityIdentity, StudioMotionOperation,
    StudioMotionProjection, StudioMotionProjectionBatch, StudioMotionProjectionEntityIdentity,
    ...
    StudioSvgPathAssetInspection, StudioSvgPathError, StudioTextFontFamily,
