...
pub use authoring::{
    ...
    StaticRootTransformOperationKind, StaticRootTransformOrigin, StaticRootTransformProgram,
    ...
    StudioMathTexTransformProjectedMotion, StudioMathTexTransformProjectedReplacement,
    StudioMathTexTransformProjection, StudioMathTexTransformProjectionEntityIdentity,
    StudioMathTexTransformProjectionInsertion, StudioMathTexTransformSourceBinding,
    StudioMathTexTransformStrategy, StudioMotionEasing, StudioMotionEntityIdentity,
    StudioMotionOperation, StudioMotionProgram, StudioMotionSourceBinding,
    StudioPersistentRemoveProjection, StudioPersistentRemoveProjectionEntry,
    StudioProgramAnchorSource, StudioProgramExecution, StudioProgramScheduleMode,
    ...
    StudioTimelinePurpose, StudioTimelineWaitReduction, project_studio_math_tex_transform_programs,
