...
pub use authoring::{
    ...
    CreateSceneEntitiesError, RotateSceneEntityCommand, RotateSceneEntityError, ScaleAboutPivot,
    SceneEntityAxisFactors, SetSubtreeVectorPaintAlphaCommand, SetSubtreeVectorPaintAlphaError,
    ...
    StudioCreationProgram, StudioMotionEasing, StudioMotionEntityIdentity, StudioMotionOperation,
    StudioMotionProgram, StudioMotionSourceBinding, StudioTimelineEventKind,
    StudioTimelineOperation, StudioTimelineProgram, StudioTimelinePurpose,
