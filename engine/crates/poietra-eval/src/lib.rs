...
pub use authoring::{
    ...
    StudioCreationOperationKind, StudioCreationProgram, StudioCreationProjectedMutation,
    StudioCreationProjectedMutationKind, StudioCreationProjection, StudioMathTexContent,
