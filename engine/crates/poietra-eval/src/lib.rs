...
pub use authoring::{
    ...
    ProjectStudioMotionEditCommand, ProjectStudioMotionEditError,
    ...
    StudioBoundEntityEditCapabilities, StudioBoundEntityEditPhase, StudioBoundEntityExecution,
    StudioBoundEntityOperation, StudioBoundEntityProgram, StudioBoundEntityScheduleMode,
    StudioCreationEntitySpec, StudioCreationMathTexOutline, StudioCreationOperation,
    StudioCreationOperationKind, StudioCreationProgram, StudioMathTexContent,
    ...
    StudioProgramScheduleMode, StudioProjectedMotion, StudioTimelineEditTransform,
    StudioTimelineEventKind, StudioTimelineOperation, StudioTimelineProgram,
    StudioTimelineProgramProjection, StudioTimelineProjection, StudioTimelinePurpose,
    StudioTimelineWaitReduction, project_studio_math_tex_transform_programs,
