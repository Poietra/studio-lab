...
use poietra_scene_ir::{
    ...
    FidelityV1, FillRuleV1, FillStyleV1, IntervalV1, KeyframeV1, MotionPathParameterizationV1,
    PointV1, ProvenanceOriginV1, ProvenanceRecordV1, RgbaColorV1, SceneAppearanceV1,
...
use identity::{
    ...
    resolve_studio_motion_targets, studio_math_tex_transform_identity_is_closed,
};
pub use presence::{
