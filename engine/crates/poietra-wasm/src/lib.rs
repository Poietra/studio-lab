...
pub use authoring::{
    apply_static_root_transform_edit_v1, apply_studio_creation_edit_v1, create_scene_motion_v1,
...
pub const POIETRA_ENGINE_ABI_VERSION: u32 = 10;
...
mod tests {
    ...
    fn exported_abi_versions_are_explicit() {
        assert_eq!(poietra_engine_abi_version(), 10);
