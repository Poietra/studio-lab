...
pub use authoring::{
    ...
    apply_studio_timeline_edit_v1, create_scene_motion_v1, rotate_scene_entity_v1,
...
pub const POIETRA_ENGINE_ABI_VERSION: u32 = 11;
...
mod tests {
    ...
    fn exported_abi_versions_are_explicit() {
        assert_eq!(poietra_engine_abi_version(), 11);
