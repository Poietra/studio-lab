...
async function openOfficialRuntimeTrace(page: Page, sceneLabel = SCENE_LABEL) {
...
test("applies generic initial opacity through real Runtime Trace and retained WebGPU", async ({ page }) => {
  test.setTimeout(180_000);
  const response = await openOfficialRuntimeTrace(page, "scene_runtime_trace_v3.py · StaticSquare");
