...
export const ACCOUNT_E2E_INVITED_IDENTITY = Object.freeze({
  issuer: ACCOUNT_E2E_IDENTITY.issuer,
  subject: "account-e2e-invited-user",
  verifiedEmail: "invited@example.com",
});
export const ACCOUNT_E2E_MISMATCH_IDENTITY = Object.freeze({
  issuer: ACCOUNT_E2E_IDENTITY.issuer,
...
export const ACCOUNT_EDITOR_DOCUMENT_FIXTURE_V1 = Object.freeze({
  ...
  ownerOidcSubject: ACCOUNT_E2E_IDENTITY.subject,
