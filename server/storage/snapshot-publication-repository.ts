...
/** Exact snapshot-artifact locator; `objectGeneration` keeps the legacy persisted spelling of the random object locator token (ADR 0005), never an ordered generation. */
