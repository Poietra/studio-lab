...
export const MAX_FAST_MANIM_RUNTIME_TRACE_NORMALIZED_KEYFRAMES_V3 = 100_000;
export const MAX_FAST_MANIM_RUNTIME_TRACE_NORMALIZED_PATH_SEGMENTS_V3 = MAX_TOTAL_PATH_SEGMENTS;
