...
/** The producer-owned selector wraps one bounded combined document plus a 64 KiB envelope. */
export const MAX_FAST_MANIM_PROFILE_SELECTION_RESULT_JSON_BYTES =
  MAX_FAST_MANIM_SOURCE_RUNTIME_IDENTITY_RESULT_JSON_BYTES + 64 * 1024;
