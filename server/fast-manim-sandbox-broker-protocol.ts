...
export const MAX_FAST_MANIM_SANDBOX_BROKER_START_RESULT_FRAME_BYTES_V1 =
  4 * Math.ceil(MAX_FAST_MANIM_SOURCE_RUNTIME_IDENTITY_RESULT_JSON_BYTES / 3) + FRAME_METADATA_BYTES;
...
const wireBackendResultV1Schema = z.discriminatedUnion("kind", [
  z
    .object({
      ...
      kind: z.literal("ok"),
      requestDigest: sha256V1Schema,
      resultBytesBase64: canonicalBase64Within(MAX_FAST_MANIM_SOURCE_RUNTIME_IDENTITY_RESULT_JSON_BYTES),
    })
    .strict(),
  z
    .object({
...
export function encodeFastManimSandboxBrokerResultBytesV1(value: Uint8Array) {
  if (value.byteLength > MAX_FAST_MANIM_SOURCE_RUNTIME_IDENTITY_RESULT_JSON_BYTES)
...
export function decodeFastManimSandboxBrokerResultBytesV1(value: string) {
  return decodeCanonicalBase64(value, MAX_FAST_MANIM_SOURCE_RUNTIME_IDENTITY_RESULT_JSON_BYTES);
}
